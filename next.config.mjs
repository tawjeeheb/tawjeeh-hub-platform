...
const nextConfig = {
  ...
  // Security headers applied to every response. Server-side protection only;
  // never rely on the client for access control.
  async headers() {
    const csp = [
      "default-src 'self'",
      "base-uri 'self'",
      ...
      "font-src 'self' data:",
      // Next.js requires inline styles/scripts in dev; kept permissive but scoped.
